...
import { faEllipsis, faStar, faBookOpenReader, faCircleXmark} from '@fortawesome/free-solid-svg-icons';
import Spinner from './components/Spinner';


library.add(faEllipsis, faStar, faBookOpenReader, faCircleXmark);
